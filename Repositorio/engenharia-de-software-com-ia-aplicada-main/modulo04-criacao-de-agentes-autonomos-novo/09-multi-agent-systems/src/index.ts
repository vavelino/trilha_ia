...
import { TeamStrategy } from "./team/team-strategy.js";
import {
...
export function bootstrapOpsPilot() {
  ...
  // Structural tool partition per team role (spec 018 FR-007):
  // analista reads only; executor mutates incidents only; planejador has none.
  const team = new TeamStrategy({
    modelFactory: createModel,
    analistaTools: [
...
export { TeamStrategy } from "./team/team-strategy.js";
